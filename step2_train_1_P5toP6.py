...
parser.add_argument('--data_dir', type=str, default= 'data/',
                    help='data file name containing the discrete files.')
parser.add_argument('--data_sample_size', type=int, default=1233,#5000,1233,
                    help='the number of samples of data')
parser.add_argument('--data_variable_size', type=int, default=102,#10,102
...
parser.add_argument('--path', type=str, default='data/GSE104276_all_pfc_2394_UMI_TPM_NOERCC_P5toP6_preprocessing_deg.csv',
